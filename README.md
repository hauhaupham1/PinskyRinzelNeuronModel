...
- The original code is from [Marte Julie's PRmodel](https://github.com/CINPLA/PRmodel/blob/master/PRmodel/solve_PRmodel.py), further extended to include JAX/Diffrax implementations and network capabilities.
- `paths.py` and `solution.py` are adapted from [Cholberg's snnax implementation](https://github.com/cholberg/snnax).
- Related paper: [Rough Signals (arXiv:2405.13587)](https://arxiv.org/abs/2405.13587)
